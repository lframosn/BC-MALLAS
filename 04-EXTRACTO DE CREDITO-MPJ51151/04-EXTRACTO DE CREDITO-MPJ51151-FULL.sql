...
CREATE TABLE IF NOT EXISTS "STG_SAT"."PCIMPEXT_LI" (
    ...
    "DISBLECRELIN"	DECIMAL	(17,2) ,
	"FILLER1" VARCHAR(857) NULL 
)  COMMIT;
...
CREATE TABLE IF NOT EXISTS "STG_SAT"."PCIMPEXT_MX" (
	...
	"TIPOLIN" VARCHAR(4) NULL ,
    "IMPAMPAG_DIF"	DECIMAL	(17,2),	--IMPORTE DE PAGOS AMORTIZADOS PARA COMPRAS EN CUOTAS
	"IMPAMPAG_REV"	DECIMAL	(17,2),	--IMPORTE DE PAGOS AMORTIZADOS
	"FILLER1" VARCHAR(555) NULL 
)  COMMIT;
...
COMMIT;
CREATE TABLE "STG_SAT"."PCIMPEXT_SZ" (
	"CODENT_D" VARCHAR(4) NULL ,
	"NSECFIC_D" DECIMAL(10,0) NULL ,
	"TIPOCINTA_D" DECIMAL(2,0) NULL ,
	"TIPOREG_D" VARCHAR(1) NULL ,
...
,@VERSION_COMMIT = '4f6ae9fb7a6d032f0cf7594c346c4d1054047668'
,@VERSION_CODE = '4f6ae9f'
,@VERSION_DATE = 'April 22, 2019 2:03:32 PM'
,@CRDATE = NULL
...
,@OBJECT_NAME = 'PCIMPEXT_CU'
,@OBJECT_USER = 'STG_SAT'
,@VERSION_COMMIT = '576c14847f58d85e9b9f30384e3b567cad676cf1'
,@VERSION_CODE = '576c148'
,@VERSION_DATE = 'February 5, 2019 11:51:38 AM'
,@CRDATE = NULL
...
select 
 @NOMBRE_MALLA = 'MPJ51151'
,@OBJECT_USER = 'STG_SAT'
,@VERSION_COMMIT = '1ab56df4336265cf3b6c36375208d3592a61137e'
,@VERSION_CODE = '1ab56df'
,@VERSION_DATE = 'February 20, 2019 10:44:01 AM'
