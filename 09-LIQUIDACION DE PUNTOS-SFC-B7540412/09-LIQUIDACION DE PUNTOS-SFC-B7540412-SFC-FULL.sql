...
,@OBJECT_USER = 'SAT'
,@VERSION_COMMIT = '9c56abf371922503acaa34d9e0134c1b64094f95'
,@VERSION_CODE = '9c56abf'
,@VERSION_DATE = 'February 8, 2019 10:27:14 AM'
,@CRDATE = NULL
...
IF NOT EXISTS(SELECT 1 FROM "CNF"."MALLAS" WHERE "NOMBRE_MALLA" = 'B7540412' )
BEGIN
  INSERT INTO "CNF"."MALLAS" ("NOMBRE_MALLA","DESCRIPCION","ENCABEZADO","CONTROL_FECHA") VALUES('B7540412','SFC Liquidacion de Puntos',1,0);
END
COMMIT;