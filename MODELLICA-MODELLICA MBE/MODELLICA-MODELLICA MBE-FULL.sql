...
drop table IF EXISTS STG_SAT.CUS_COMP_MBE;  CREATE TABLE IF NOT EXISTS STG_SAT.CUS_COMP_MBE  ( 	SYSTEMDATE	DATE		--SYSTEMDATE
,	SYSTEMTIME	VARCHAR	(255)	--SYSTEMTIME
,	CLIENTSYSTEM	VARCHAR	(255)	--CLIENTSYSTEM
,	CLIENTTCPIP	VARCHAR	(255)	--CLIENTTCPIP
,	COMP_USER	VARCHAR	(255)	--USER
...
,@OBJECT_USER = 'SAT'
,@VERSION_COMMIT = 'ccffaac18202401b627136d1ae3612a0f74840c0'
,@VERSION_CODE = 'ccffaac'
,@VERSION_DATE = 'April 8, 2019 7:22:15 PM'
,@CRDATE = NULL
...
IF EXISTS(SELECT 1 FROM CNF.CAT_JOBS WHERE NOMBRE_JOB = 'JOB_CUST_MBE' AND NOMBRE_TABLA = 'CUS_COMP_MBE')
  DELETE CNF.CAT_JOBS WHERE NOMBRE_JOB = 'JOB_CUST_MBE' AND NOMBRE_TABLA = 'CUS_COMP_MBE'

INSERT INTO "CNF"."CAT_JOBS" ("nombre_job","nombre_tabla","tipo_carga","reproceso") 
VALUES('JOB_CUST_MBE','CUS_COMP_MBE',NULL,0)
